<?php
	 ...
	 * listing a collection of ArticleRevisions objects.  It includes
	 ...
	 * 
	 */
	class ArticleRevisionsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ArticleRevisions datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ArticleRevisions object, or it can be any QQNode extending from QQN::ArticleRevisions().
		 * 
		 ...
		 * sorting using two fields from the ArticleRevisions object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ArticleRevisions
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = ArticleRevisions::CountAll();
			}
			...
			// Set the DataSource to be a Query result from ArticleRevisions, given the clauses above
			$this->DataSource = ArticleRevisions::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ArticleRevisions-based QQNode.
		 * It will also verify that it is a proper ArticleRevisions-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'article_revisions') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "article_revisions".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ArticleRevisions()->Id;
				case 'ArticleId': return QQN::ArticleRevisions()->ArticleId;
				case 'Article': return QQN::ArticleRevisions()->Article;
				case 'VisitorId': return QQN::ArticleRevisions()->VisitorId;
				case 'Visitor': return QQN::ArticleRevisions()->Visitor;
				case 'ArticleContent': return QQN::ArticleRevisions()->ArticleContent;

				default: throw new QCallerException('Simple Property not found in ArticleRevisionsDataGrid content: ' . $mixContent);
